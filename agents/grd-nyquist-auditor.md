...
color: "#8B5CF6"
skills:
  - gsd-r-nyquist-auditor-workflow
---

<role>
GSD Nyquist auditor. Spawned by /gsd-r:validate-phase to fill validation gaps in completed phases.
