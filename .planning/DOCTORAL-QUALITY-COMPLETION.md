...
### 1A. `get-shit-done-r/workflows/new-milestone.md`
...
### 1B. `get-shit-done-r/templates/research-project/SUMMARY.md`
...
### 1C. `get-shit-done-r/templates/requirements.md`
...
grep -rn "STACK\.md\|FEATURES\.md\|ARCHITECTURE\.md\|PITFALLS\.md" \
  agents/ get-shit-done-r/workflows/ get-shit-done-r/templates/ \
  --include="*.md" | grep -iv codebase | grep -iv "\.planning/codebase"
```

**Expected:** Zero hits. If any remain, they're bugs — fix them.

**Exception:** `get-shit-done-r/workflows/help.md` lines 370-371 reference `codebase/STACK.md` and `codebase/ARCHITECTURE.md` — these are codebase mapping files, NOT research templates. Leave them.

### 2B. Verify new templates exist
```bash
ls get-shit-done-r/templates/research-project/
```
**Expected:** DEBATES.md, FRAMEWORKS.md, LANDSCAPE.md, QUESTIONS.md, SUMMARY.md

### 2C. Verify old templates deleted
```bash
test ! -f get-shit-done-r/templates/research-project/STACK.md && echo "DELETED OK"
test ! -f get-shit-done-r/templates/research-project/FEATURES.md && echo "DELETED OK"
test ! -f get-shit-done-r/templates/research-project/ARCHITECTURE.md && echo "DELETED OK"
test ! -f get-shit-done-r/templates/research-project/PITFALLS.md && echo "DELETED OK"
```

### 2D. Verify new reference file exists
```bash
test -f get-shit-done-r/references/research-depth.md && echo "EXISTS OK"
```
...
```bash
grep -c "LANDSCAPE\|QUESTIONS\|FRAMEWORKS\|DEBATES" agents/gsd-r-project-researcher.md
grep -c "LANDSCAPE\|QUESTIONS\|FRAMEWORKS\|DEBATES" agents/gsd-r-research-synthesizer.md
grep -c "LANDSCAPE\|QUESTIONS\|FRAMEWORKS\|DEBATES" get-shit-done-r/workflows/new-project.md
grep -c "LANDSCAPE\|QUESTIONS\|FRAMEWORKS\|DEBATES" get-shit-done-r/workflows/new-milestone.md
```
**Expected:** All >10.
...
```bash
# Wave 1: Foundation
git add get-shit-done-r/references/questioning.md
git add get-shit-done-r/references/research-depth.md
git add get-shit-done-r/templates/research-project/LANDSCAPE.md
git add get-shit-done-r/templates/research-project/QUESTIONS.md
git add get-shit-done-r/templates/research-project/FRAMEWORKS.md
git add get-shit-done-r/templates/research-project/DEBATES.md
git add get-shit-done-r/templates/research.md
git add get-shit-done-r/templates/research-task.md
git add get-shit-done-r/templates/research-project/SUMMARY.md
git add get-shit-done-r/templates/requirements.md

# Wave 2: Agents
git add agents/gsd-r-project-researcher.md
git add agents/gsd-r-phase-researcher.md
git add agents/gsd-r-source-researcher.md
git add agents/gsd-r-methods-researcher.md
git add agents/gsd-r-limitations-researcher.md
git add agents/gsd-r-architecture-researcher.md

# Wave 3: Orchestrators & consumers
git add get-shit-done-r/workflows/new-project.md
git add get-shit-done-r/workflows/new-milestone.md
git add agents/gsd-r-research-synthesizer.md
git add get-shit-done-r/workflows/discuss-phase.md
git add get-shit-done-r/templates/research-task.md

# Wave 4: Cleanup
git add get-shit-done-r/templates/research-project/STACK.md
git add get-shit-done-r/templates/research-project/FEATURES.md
git add get-shit-done-r/templates/research-project/ARCHITECTURE.md
git add get-shit-done-r/templates/research-project/PITFALLS.md
git add GSD-R-Fork-Plan.md
git add .gitignore
```
...
gh repo create get-shit-done-r --public \
...
git remote add origin https://github.com/YOUR_USERNAME/get-shit-done-r.git
