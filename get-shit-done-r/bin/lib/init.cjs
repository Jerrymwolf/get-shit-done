...
function cmdInitExecutePhase(cwd, phase, raw) {
  ...
  const result = {
    // Models
    executor_model: resolveModelInternal(cwd, 'gsd-r-executor'),
    verifier_model: resolveModelInternal(cwd, 'gsd-r-verifier'),
...
function cmdInitPlanPhase(cwd, phase, raw) {
  ...
  const result = {
    // Models
    researcher_model: resolveModelInternal(cwd, 'gsd-r-phase-researcher'),
    planner_model: resolveModelInternal(cwd, 'gsd-r-planner'),
    checker_model: resolveModelInternal(cwd, 'gsd-r-plan-checker'),
...
function cmdInitNewProject(cwd, raw) {
  ...
  const result = {
    // Models
    researcher_model: resolveModelInternal(cwd, 'gsd-r-project-researcher'),
    synthesizer_model: resolveModelInternal(cwd, 'gsd-r-research-synthesizer'),
    roadmapper_model: resolveModelInternal(cwd, 'gsd-r-roadmapper'),
...
function cmdInitMapCodebase(cwd, raw) {
  ...
  const result = {
    // Models
    mapper_model: resolveModelInternal(cwd, 'gsd-r-codebase-mapper'),
