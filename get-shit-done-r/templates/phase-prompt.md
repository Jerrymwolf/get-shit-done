...
> **Note:** Planning methodology is in `agents/gsd-r-planner.md`.
...
<!-- For checkpoint task examples and patterns, see @/Users/jeremiahwolf/.claude/get-shit-done-r/references/checkpoints.md -->
...
**Wave is pre-computed:** Wave numbers are assigned during `/gsd-r:plan-phase`. Execute-phase reads `wave` directly from frontmatter and groups plans by wave number. No runtime dependency analysis needed.
...
See `/Users/jeremiahwolf/.claude/get-shit-done-r/references/tdd.md` for TDD plan structure.
...
See `/Users/jeremiahwolf/.claude/get-shit-done-r/templates/user-setup.md` for full schema and examples
...
See `/Users/jeremiahwolf/.claude/get-shit-done-r/workflows/verify-phase.md` for verification logic.
