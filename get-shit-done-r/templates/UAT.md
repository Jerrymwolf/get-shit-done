...
- This section feeds directly into /gsd-r:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /gsd-r:plan-phase --gaps with root causes
...
**Creation:** When /gsd-r:verify-work starts new session
