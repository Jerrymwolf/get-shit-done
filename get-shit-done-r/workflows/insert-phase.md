...
Example: `/gsd-r:insert-phase 72 Fix critical auth bug`
-> after = 72
...
Usage: /gsd-r:insert-phase <after> <description>
Example: /gsd-r:insert-phase 72 Fix critical auth bug
```
...
```bash
INIT=$(node "/Users/jeremiahwolf/.claude/get-shit-done-r/bin/gsd-r-tools.cjs" init phase-op "${after_phase}")
...
```bash
RESULT=$(node "/Users/jeremiahwolf/.claude/get-shit-done-r/bin/gsd-r-tools.cjs" phase insert "${after_phase}" "${description}")
```
...
`/gsd-r:plan-phase {decimal_phase}`
...
- Don't use this for planned work at end of milestone (use /gsd-r:add-phase)
- Don't insert before Phase 1 (decimal 0.1 makes no sense)
- Don't renumber existing phases
- Don't modify the target phase content
- Don't create plans yet (that's /gsd-r:plan-phase)
