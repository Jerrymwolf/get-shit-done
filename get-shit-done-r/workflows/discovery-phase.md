...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /gsd-r:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See /Users/jeremiahwolf/.claude/get-shit-done-r/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /Users/jeremiahwolf/.claude/get-shit-done-r/templates/discovery.md structure:
...
1. **Scope the discovery** using /Users/jeremiahwolf/.claude/get-shit-done-r/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /Users/jeremiahwolf/.claude/get-shit-done-r/templates/discovery.md
...
Use /Users/jeremiahwolf/.claude/get-shit-done-r/templates/discovery.md.
...
1. Discuss phase context (/gsd-r:discuss-phase [current-phase])
2. Create phase plan (/gsd-r:plan-phase [current-phase])
