...
```bash
TRANSITION=$(node "/Users/jeremiahwolf/.claude/get-shit-done-r/bin/gsd-r-tools.cjs" phase complete "${current_phase}")
```
...
```bash
PROGRESS=$(node "/Users/jeremiahwolf/.claude/get-shit-done-r/bin/gsd-r-tools.cjs" progress bar --raw)
```
...
Exit skill and invoke SlashCommand("/gsd-r:plan-phase [X+1] --auto")
...
Exit skill and invoke SlashCommand("/gsd-r:discuss-phase [X+1] --auto")
...
`/gsd-r:discuss-phase [X+1]` — gather context and clarify approach
...
**Also available:**
- `/gsd-r:plan-phase [X+1]` — skip discussion, plan directly
- `/gsd-r:research-phase [X+1]` — investigate unknowns
...
**Also available:**
- `/gsd-r:discuss-phase [X+1]` — revisit context
- `/gsd-r:research-phase [X+1]` — investigate unknowns
...
```bash
node "/Users/jeremiahwolf/.claude/get-shit-done-r/bin/gsd-r-tools.cjs" config-set workflow._auto_chain_active false
```
...
Exit skill and invoke SlashCommand("/gsd-r:complete-milestone {version}")
