...
- File reference: `/gsd-r:new-project --auto @prd.md`
...
Usage:
  /gsd-r:new-project --auto @your-idea.md
  /gsd-r:new-project --auto [paste or write your idea here]
...
```bash
INIT=$(node "/Users/jeremiahwolf/.claude/get-shit-done-r/bin/gsd-r-tools.cjs" init new-project)
if [[ "$INIT" == @file:* ]]; then INIT=$(cat "${INIT#@file:}"); fi
```

Parse JSON for: `researcher_model`, `synthesizer_model`, `roadmapper_model`, `commit_docs`, `project_exists`, `has_codebase_map`, `planning_exists`, `has_existing_code`, `has_package_file`, `is_brownfield`, `needs_codebase_map`, `has_git`, `project_path`.

**If `project_exists` is true:** Error — project already initialized. Use `/gsd-r:progress`.
...
- options:
  - "Map codebase first" — Run /gsd-r:map-codebase to understand existing architecture (Recommended)
  - "Skip mapping" — Proceed with project initialization

**If "Map codebase first":**
```
Run `/gsd-r:map-codebase` first, then return to `/gsd-r:new-project`
```
Exit command.
...
```bash
mkdir -p .planning
node "/Users/jeremiahwolf/.claude/get-shit-done-r/bin/gsd-r-tools.cjs" commit "chore: add project config" --files .planning/config.json
```
...
```bash
mkdir -p .planning
node "/Users/jeremiahwolf/.claude/get-shit-done-r/bin/gsd-r-tools.cjs" commit "docs: initialize project" --files .planning/PROJECT.md
```
...
**Note:** Run `/gsd-r:settings` anytime to update these preferences.
...
Spawn 4 parallel gsd-r-project-researcher agents with path references:
...
Use template: /Users/jeremiahwolf/.claude/get-shit-done-r/templates/research-project/LANDSCAPE.md
</output>
", subagent_type="gsd-r-project-researcher", model="{researcher_model}", description="Landscape research")
...
Use template: /Users/jeremiahwolf/.claude/get-shit-done-r/templates/research-project/QUESTIONS.md
</output>
", subagent_type="gsd-r-project-researcher", model="{researcher_model}", description="Questions research")
...
Use template: /Users/jeremiahwolf/.claude/get-shit-done-r/templates/research-project/FRAMEWORKS.md
</output>
", subagent_type="gsd-r-project-researcher", model="{researcher_model}", description="Frameworks research")
...
Use template: /Users/jeremiahwolf/.claude/get-shit-done-r/templates/research-project/DEBATES.md
</output>
", subagent_type="gsd-r-project-researcher", model="{researcher_model}", description="Debates research")
```
...
", subagent_type="gsd-r-research-synthesizer", model="{synthesizer_model}", description="Synthesize research")
```
...
```bash
node "/Users/jeremiahwolf/.claude/get-shit-done-r/bin/gsd-r-tools.cjs" commit "docs: define v1 requirements" --files .planning/REQUIREMENTS.md
```
...
Spawn gsd-r-roadmapper agent with path references:
...
", subagent_type="gsd-r-roadmapper", model="{roadmapper_model}", description="Create roadmap")
```
...
- Re-spawn roadmapper with revision context:
  ...
  ", subagent_type="gsd-r-roadmapper", model="{roadmapper_model}", description="Revise roadmap")
  ```
...
```bash
node "/Users/jeremiahwolf/.claude/get-shit-done-r/bin/gsd-r-tools.cjs" commit "docs: create roadmap ([N] phases)" --files .planning/ROADMAP.md .planning/STATE.md .planning/REQUIREMENTS.md
```
...
Exit skill and invoke SlashCommand("/gsd-r:discuss-phase 1 --auto")
...
/gsd-r:discuss-phase 1 — gather context and clarify approach
...
**Also available:**
- /gsd-r:plan-phase 1 — skip discussion, plan directly
...
- [ ] gsd-r-roadmapper spawned with context
- [ ] Roadmap files written immediately (not draft)
- [ ] User feedback incorporated (if any)
- [ ] ROADMAP.md created with phases, requirement mappings, success criteria
- [ ] STATE.md initialized
- [ ] REQUIREMENTS.md traceability updated
- [ ] User knows next step is `/gsd-r:discuss-phase 1`
