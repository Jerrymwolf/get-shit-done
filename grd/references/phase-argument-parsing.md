...
```bash
PHASE_INFO=$(node "/Users/jeremiahwolf/.claude/grd/bin/grd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "/Users/jeremiahwolf/.claude/grd/bin/grd-tools.cjs" roadmap get-phase "${PHASE}")
...
```bash
PHASE_DIR=$(node "/Users/jeremiahwolf/.claude/grd/bin/grd-tools.cjs" find-phase "${PHASE}" --raw)
```
