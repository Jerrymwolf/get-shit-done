...
|-------|-----------|------------|----------|-----------|
| grd-planner | opus | opus | sonnet | inherit |
| grd-roadmapper | opus | sonnet | sonnet | inherit |
| grd-executor | opus | sonnet | sonnet | inherit |
| grd-phase-researcher | opus | sonnet | haiku | inherit |
| grd-project-researcher | opus | sonnet | haiku | inherit |
| grd-research-synthesizer | sonnet | sonnet | haiku | inherit |
| grd-debugger | opus | sonnet | sonnet | inherit |
| grd-codebase-mapper | sonnet | haiku | haiku | inherit |
| grd-verifier | sonnet | sonnet | haiku | inherit |
| grd-plan-checker | sonnet | sonnet | haiku | inherit |
| grd-integration-checker | sonnet | sonnet | haiku | inherit |
| grd-nyquist-auditor | sonnet | sonnet | haiku | inherit |
