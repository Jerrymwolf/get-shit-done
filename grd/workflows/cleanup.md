...
```bash
node "/Users/jeremiahwolf/.claude/grd/bin/grd-tools.cjs" commit "chore: archive phase directories from completed milestones" --files .planning/milestones/ .planning/phases/
```
