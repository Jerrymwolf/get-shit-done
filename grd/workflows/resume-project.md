...
<required_reading>
@/Users/jeremiahwolf/.claude/grd/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/Users/jeremiahwolf/.claude/grd/bin/grd-tools.cjs" init resume)
...
- This is the primary resumption source — structured data from `/grd:pause-work`
...
1. Resume interrupted agent [if interrupted agent found]
   OR
1. Execute phase (/grd:conduct-inquiry {phase} ${GSD_WS})
   OR
1. Discuss Phase 3 context (/grd:scope-inquiry 3 ${GSD_WS}) [if CONTEXT.md missing]
   OR
1. Plan Phase 3 (/grd:plan-inquiry 3 ${GSD_WS}) [if CONTEXT.md exists or discuss option declined]
...
If missing, suggest scope-inquiry before plan. If exists, offer plan directly.
...
- **Plan phase** → Show command for user to run after clearing:
  ...
  **Also available:**
  - `/grd:scope-inquiry [N] ${GSD_WS}` — gather context first
  - `/grd:research-phase [N] ${GSD_WS}` — investigate unknowns
