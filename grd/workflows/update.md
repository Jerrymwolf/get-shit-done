...
for entry in "${ORDERED_RUNTIME_DIRS[@]}"; do
  ...
  if [ -f "./$dir/grd/VERSION" ] || [ -f "./$dir/grd/workflows/update.md" ]; then
    ...
    LOCAL_VERSION_FILE="./$dir/grd/VERSION"
    LOCAL_MARKER_FILE="./$dir/grd/workflows/update.md"
...
for entry in "${ORDERED_RUNTIME_DIRS[@]}"; do
  ...
  if [ -f "$HOME/$dir/grd/VERSION" ] || [ -f "$HOME/$dir/grd/workflows/update.md" ]; then
    ...
    GLOBAL_VERSION_FILE="$HOME/$dir/grd/VERSION"
    GLOBAL_MARKER_FILE="$HOME/$dir/grd/workflows/update.md"
