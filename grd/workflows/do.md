...
| A complex task: refactoring, migration, multi-file architecture, system redesign | `/grd:add-inquiry` | Needs a full phase with plan/build cycle |
...
1. /grd:add-inquiry — Full planning cycle (recommended for multi-file refactors)
