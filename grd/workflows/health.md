...
```bash
node "/Users/jeremiahwolf/.claude/grd/bin/grd-tools.cjs" validate health $REPAIR_FLAG
```
...
- [W001] STATE.md references phase 5, but only phases 1-3 exist
  Fix: Run /grd:health --repair to regenerate
...
```
---
N issues can be auto-repaired. Run: /grd:health --repair
```
</step>
...
```
Would you like to run /grd:health --repair to fix N issues automatically?
```
...
```bash
node "/Users/jeremiahwolf/.claude/grd/bin/grd-tools.cjs" validate health
```
