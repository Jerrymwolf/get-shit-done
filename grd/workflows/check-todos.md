...
```bash
INIT=$(node "/Users/jeremiahwolf/.claude/grd/bin/grd-tools.cjs" init todos)
...
- options:
  - "Work on it now" — move to done, start working
  - "Create a phase" — /grd:add-inquiry with this scope
  - "Brainstorm approach" — think through before deciding
  - "Put it back" — return to list
</step>
...
**Create a phase:**
Display: `/grd:add-inquiry [description from todo]`
...
node "/Users/jeremiahwolf/.claude/grd/bin/grd-tools.cjs" commit "docs: start work on todo - [title]" --files .planning/todos/done/[filename] .planning/STATE.md
```
