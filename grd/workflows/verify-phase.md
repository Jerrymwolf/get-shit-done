...
<required_reading>
@/Users/jeremiahwolf/.claude/grd/references/verification-patterns.md
@/Users/jeremiahwolf/.claude/grd/templates/verification-report.md
</required_reading>
...
for plan in "$PHASE_DIR"/*-PLAN.md; do
  MUST_HAVES=$(node "/Users/jeremiahwolf/.claude/grd/bin/grd-tools.cjs" frontmatter get "$plan" --field must_haves)
...
```bash
PHASE_DATA=$(node "/Users/jeremiahwolf/.claude/grd/bin/grd-tools.cjs" roadmap get-phase "${phase_number}" --raw)
```
...
```bash
for plan in "$PHASE_DIR"/*-PLAN.md; do
  ARTIFACT_RESULT=$(node "/Users/jeremiahwolf/.claude/grd/bin/grd-tools.cjs" verify artifacts "$plan")
...
```bash
for plan in "$PHASE_DIR"/*-PLAN.md; do
  LINKS_RESULT=$(node "/Users/jeremiahwolf/.claude/grd/bin/grd-tools.cjs" verify key-links "$plan")
...
See /Users/jeremiahwolf/.claude/grd/templates/verification-report.md for complete template.
</step>
