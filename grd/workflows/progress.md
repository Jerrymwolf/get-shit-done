...
```bash
INIT=$(node "/Users/jeremiahwolf/.claude/grd/bin/grd-tools.cjs" init progress)
...
- `STATE=$(node "/Users/jeremiahwolf/.claude/grd/bin/grd-tools.cjs" state-snapshot)`
...
- Use `summary-extract` for efficient parsing:
  ```bash
  node "/Users/jeremiahwolf/.claude/grd/bin/grd-tools.cjs" summary-extract <path> --fields one_liner
  ```
...
PROGRESS_BAR=$(node "/Users/jeremiahwolf/.claude/grd/bin/grd-tools.cjs" progress bar --raw)
```
