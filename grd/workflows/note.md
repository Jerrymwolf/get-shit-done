...
4. **Requires `.planning/` directory** — if it doesn't exist, warn: "Todos require a GRD project. Run `/grd:new-project` to initialize one."
...
3. **Promote without project**: Warns that todos require `.planning/`, suggests `/grd:new-project`
