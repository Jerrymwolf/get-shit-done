...
- **State C** (`SUMMARY_FILES` empty): Exit — "Phase {N} not executed. Run /grd:conduct-inquiry {N} ${GSD_WS} first."
...
Task(
  ...
  subagent_type="grd-nyquist-auditor",
  model="{AUDITOR_MODEL}",
...
**State B (create):**
1. Read template from `/Users/jeremiahwolf/.claude/grd/templates/VALIDATION.md`
...
node "/Users/jeremiahwolf/.claude/grd/bin/grd-tools.cjs" commit "docs(phase-${PHASE}): add/update validation strategy"
```
