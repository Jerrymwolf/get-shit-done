...
```bash
INIT=$(node "/Users/jeremiahwolf/.claude/grd/bin/grd-tools.cjs" init phase-op "0")
...
<step name="add_phase">
**Delegate the phase addition to grd-tools:**

```bash
RESULT=$(node "/Users/jeremiahwolf/.claude/grd/bin/grd-tools.cjs" phase add "${description}")
```
