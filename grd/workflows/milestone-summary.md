...
```bash
grd-tools.cjs commit "docs(v${VERSION}): generate milestone summary for onboarding" \
...
If the user is done:
- Suggest next steps: `/grd:new-milestone`, `/grd:progress`, or sharing the summary with the team
