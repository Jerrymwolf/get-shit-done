...
const VALID_CONFIG_KEYS = new Set([
  ...
  'workflow.nyquist_validation', 'workflow.presentation_design', 'workflow.presentation_gate',
  ...
  // GRD v1.2 config schema extensions
 ...
 *   3. userChoices -- the settings the user explicitly selected during /grd:new-research
 *
 ...
 * configured during /grd:new-research). All remaining keys are filled from
