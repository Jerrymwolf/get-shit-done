...
**New Template:**
- Implementation: `grd/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `grd/workflows/{name}.md`
- Usage: Reference from command with `@/Users/jeremiahwolf/.claude/grd/workflows/{name}.md`

**New Reference Document:**
- Implementation: `grd/references/{name}.md`
