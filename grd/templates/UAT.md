...
- This section feeds directly into /grd:plan-inquiry --gaps
...
5. status -> "diagnosed"
6. Ready for /grd:plan-inquiry --gaps with root causes
...
**Creation:** When /grd:verify-inquiry starts new session
...
- `/grd:verify-inquiry {phase}` picks up from first pending/blocked test
