...
**Wave is pre-computed:** Wave numbers are assigned during `/grd:plan-inquiry`. Execute-phase reads `wave` directly from frontmatter and groups plans by wave number. No runtime dependency analysis needed.
...
See `/Users/jeremiahwolf/.claude/grd/references/tdd.md` for TDD plan structure.
...
See `/Users/jeremiahwolf/.claude/grd/templates/user-setup.md` for full schema and examples
...
See `/Users/jeremiahwolf/.claude/grd/workflows/verify-phase.md` for verification logic.
